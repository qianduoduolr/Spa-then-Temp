...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path', default='/home/lr/project/vcl_ops/configs/test/res18_d8.py')
...
def main():
    ...
    if 'output_dir' in eval_config and not args.out:
        ...
        eval_config['output_dir'] = eval_config['output_dir'] + f'indices{args.out_indices[0]}' + args.task
    else:
        args.tmpdir = args.out
        eval_config['output_dir'] = args.out + f'indices{args.out_indices[0]}' + args.task
